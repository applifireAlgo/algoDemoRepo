...
public class AppCustomerTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomercategory.setCustomerCategory("jhiCCiVi5qLHmlQHYXsORev77IRV3u8Hk28kCYrD7rutJf7Twf");
            ...
            appcustomertype.setCustomerType("KJLvIH9aG97FjaJZE2XqLp9DpeViMKNHdvIBYDd5vHCZQbszpG");
            ...
            corecontacts.setEmailId("dQevi7PDFnYhYwu7FrkzLBFPAF2v6uz7SluMPLYChCIMIadvKL");
            corecontacts.setFirstName("MEk9yZToO5v38paW3YDCoZfGYFQpnjy6T3y5hfDBXFyaFmB5Jo");
            Gender gender = new Gender();
            gender.setGender("ZmJsNGKJ3bIusMasOzBJzao9MqIqiwkm0Bt469PqCAoK6qRZWZ");
            Gender GenderTest = genderRepository.save(gender);
            map.put("GenderPrimaryKey", gender._getPrimarykey());
            Language language = new Language();
            language.setAlpha2("O6");
            language.setAlpha3("ifC");
            language.setAlpha4("c5tm");
            language.setAlpha4parentid(10);
            language.setLanguage("2TtxrCyTrG8BwbHLheM6ZRzBMZLnVJRBgWXyL1ckTSAyDgomiC");
            language.setLanguageDescription("sdV3Tc779soINcNQn2b9LNpLqCH0YoNlsQL7hb9CC7bKrJCPie");
            language.setLanguageIcon("yriwSyF2dsekfZSY9Ix04yebbWewsQD8SdfTPTxrvMVvKDWKvU");
            language.setLanguageType("Ypfr2wI0WRAec7bDwkpujoIsI1N6JXrV");
            Language LanguageTest = languageRepository.save(language);
            map.put("LanguagePrimaryKey", language._getPrimarykey());
            Timezone timezone = new Timezone();
            timezone.setCities("dffiiONhx1oZlitTqGdxJjOrXwgRRTU4AMPLXIHjS6PWLg9W6k");
            timezone.setCountry("0dcOvHNb3rSZF79IPqAMAEWqDxdKDYCcS8RvFOFxLaZJIRkd96");
            timezone.setGmtLabel("6CcyAQPYssPtGUy2YNT2qgi1r6vSD6Q4V6Hp7WTe0CgMZ2WKDr");
            timezone.setTimeZoneLabel("FBauIYgaAPmo9RLRQ5rjLRzaqR3ZppaksvjEaAMhqPfoXxQ0v2");
            timezone.setUtcdifference(9);
            Timezone TimezoneTest = timezoneRepository.save(timezone);
            map.put("TimezonePrimaryKey", timezone._getPrimarykey());
            Title title = new Title();
            title.setTitles("QwfpBYvqveIGlna8yBbb3QnSVicVAVwkLjWzKerpOyZX3HRE8A");
            Title TitleTest = titleRepository.save(title);
            map.put("TitlePrimaryKey", title._getPrimarykey());
            corecontacts.setAge(19);
            corecontacts.setApproximateDOB(new java.sql.Date(123456789));
            corecontacts.setDateofbirth(new java.sql.Date(123456789));
            corecontacts.setEmailId("pZMFrK4NHaqvxvrCaH67y7dj3SrZTDYHQdWUvdhhTQCw3lrMOE");
            corecontacts.setFirstName("ZnmKq6LRGSlYyhTZkyHiK2gBs42XkTJP5VHbBP42MlFWSFo7Lf");
            corecontacts.setGenderId((java.lang.String) GenderTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setLastName("Up7846iXlcTwPAOOrnnuk1yJCsq7inRcQBHj8Kodc02D8aqkIx");
            corecontacts.setMiddleName("jUHYP3Y3TF9VMEOX6ldEEB3jdLKKWcj9Y7sGE1nHEZ9YkENQbz");
            corecontacts.setNativeFirstName("mDX06fvtbnlptylsPXrxoqkNVlTlt2Hx3QkziT4TuM7pLpMolh");
            corecontacts.setNativeLanguageCode((java.lang.String) LanguageTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setNativeLastName("WS0WVFWGkEtLanfsnC5S8Aq5yYrfPoVebgW9V2jB2B3M6HsUgM");
            corecontacts.setNativeMiddleName("PAZCJT4of1KcFoSaa73ypsuS3QoJBjiE6GgtaIuxaXC7QZ5ODv");
            corecontacts.setNativeTitle("g3kVUtGhNg05VtFDEK5doGa4PdibZ3HHovJsYeLvIqFCrx7isZ");
            corecontacts.setPhoneNumber("rRbq8RLTNJ6rleptKm9b");
            ...
            appcustomer.setCustomerName("ZiLncXSCQNyhzrskZhgS4JkFPG052HJBFOWCdlZD3WYmmVmUPF");
    ...
    public void test2Update() {
        try {
            ...
            appcustomer.setCustomerName("hUPyWTDcd7xfNUgyLwaKTQS1kmyYeOCwqe3Ze7meTesAYti6cU");
            appcustomer.setCustomerStatus(1);
            appcustomer.setEvalTimePeriod(2147483647);
            appcustomer.setUserRequested(2147483647);
