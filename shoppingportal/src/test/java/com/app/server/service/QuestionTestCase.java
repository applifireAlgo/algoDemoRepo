...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("h2JvdU3uU1iuvUSCeDqZKauncydFzSpe3MwlMEBvNFX8Efkj3P");
            question.setQuestionDetails("sq6");
            question.setQuestionIcon("7IWnxAjFW1lh0Zx9oNiHY3Yn4drPNZFRwB5GeNFAWFRNMplILy");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("0xcnfyvTnTgqxbIEIjTj0m9mUJo7fHMrarGe5SthVd9iR5vNhU");
            question.setQuestionDetails("CyI");
            question.setQuestionIcon("ChsgmWpfCardr1HCwQUvvlazJhq64Mn9djKy3UsAlLVeoNHise");
