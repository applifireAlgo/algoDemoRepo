...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("juTw1z4A4l7owuJH1V01t6OYBKx4NLeBLoCIZIXsNxidnHDK0H");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("0e1IoM8NML7g2dCsEjoflxbfNwex1cyf6imqHQl5PXsBGKJcNg");
            appcustomertype.setDefaults(0);
            appcustomertype.setSequenceId(2147483647);
