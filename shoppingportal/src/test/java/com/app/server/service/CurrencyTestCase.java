...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("ak1DcY6sGZ984uDKkNe11P4IzFXFB3m9");
            country.setCapitalLatitude(5);
            country.setCapitalLongitude(8);
            country.setCountryCode1("TgV");
            country.setCountryCode2("BU9");
            country.setCountryFlag("5ju1eHpYeyciTQuAO462gKHdaefBvtXBRc8fgToSGlPeLRKke1");
            country.setCountryName("Rq6K2hw5cMrHkBiC9EpanzJ2qPciQssVt6RWVIYjY8dnI29gzP");
            country.setCurrencyCode("pcf");
            country.setCurrencyName("5zmR9WyOAEtabHANS7KdTDG3mRjEzoxYoZc7H0ghK1BWTPKEIS");
            country.setCurrencySymbol("Lbpnh5718wMDtev4NY28im50QNO9Kl41");
            country.setIsoNumeric(8);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("tLBgUEDVw9t9CWpDeZImdp4KLJRHZj9D9zX4QnIdaLkVEEQwyZ");
            currency.setUnicodeDecimal("bKwHHNT1hK770XMxop13cHRnNz49XU1uOyVwOYifyELqtNRZIQ");
            currency.setUnicodeHex("6M2EGvVB1LwgW8X5NA6MSB4FdmfG6Zbb7Q0mBztrNn6xtctkqp");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("iXoZFi3WKJV5sX3eL5NQReNAWbtdRv6l8yjF4V00avbmrS2aEU");
            currency.setUnicodeDecimal("eLDJKAuW0lCYFR9ICecgw6OWxMxiYD1eVKknSupeTHh5S7qxAu");
            currency.setUnicodeHex("BiuQ9c9tHgDiNQssAu8azUXRZAp0XgZPtpYS03h5dk9d7bgrlW");
